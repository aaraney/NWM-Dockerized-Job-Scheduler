...
Filepath = r'C:\Users\Iman\Desktop\pocono_test_case\DOMAIN'
Filename = 'Route_Link.nc'
outputpath = r'C:\Users\Iman\Desktop' + '\\' + Filename.split('.')[0]
...
scales_list_of_lists = (np.round(latin.sample(problem, 5), len(params_list))).tolist()


for scales_list in scales_list_of_lists:
    ds1, outputpath_final = para_editor_evenly_scaler_multi_para(Filepath, Filename, outputpath, params_list, scales_list)
